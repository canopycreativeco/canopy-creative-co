...
export default function IntakeForm() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="flex items-start gap-1.5 text-[12px] leading-[1.6] mt-3" style={{ color: '#1a1a1a' }}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-[12px] h-[12px] shrink-0 mt-[2px]">
